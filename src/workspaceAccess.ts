...
class DirectWorkspaceAccess implements WorkspaceAccess {
  ...
  selectDefaultWorkspace(): Workspace { return this.manager.selectDefaultWorkspace(); }
...
class WorktreeWorkspaceAccess implements WorkspaceAccess {
  ...
  currentWorkspaceId(): string {
    throw new CodexProError("There is no session-selected workspace in MCP worktree mode. Pass workspace_id explicitly.");
  }
