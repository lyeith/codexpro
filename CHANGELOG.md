...
- Reduced default action-journal retention from 64 MiB/50,000 actions to 8 MiB/2,000 actions and enforce the configured ceilings at HTTP startup as well as after appends, preventing dashboard refreshes from degrading indefinitely as history accumulates.
